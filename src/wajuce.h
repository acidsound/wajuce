/**
 * wajuce.h — C-API for the native WebAudio engine.
 *
 ...
 * are resolved from the compiled iPlug2-backed engine shared library.
 */
#ifndef WAJUCE_H
#define WAJUCE_H
...
FFI_PLUGIN_EXPORT void wajuce_create_machine_voice(int32_t ctx_id,
                                                   int32_t *result_ids);
FFI_PLUGIN_EXPORT void wajuce_machine_voice_set_active(int32_t ctx_id,
                                                       int32_t node_id,
                                                       int32_t active);
